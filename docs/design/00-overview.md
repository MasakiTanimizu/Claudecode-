...
三人麻雀アプリ開発の10ステップのうち、STEP1〜6の確定内容をここにまとめる。各ファイルは議論の過程ではなく**最終的に確定した仕様**を記載する。
...
| 3 | [03-database-design.md](./03-database-design.md) | DB設計 |
...
| 7〜10 | 未着手 | UI設計 / CPU思考アルゴリズム / オンライン設計 / 実装 |
